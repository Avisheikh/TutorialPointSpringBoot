...
public class FakeApplicationUserDaoService implements ApplicationUserDao
{
    ...
    private List<ApplicationUser> getApplicationUsers(){
        List<ApplicationUser> applicationUsers = Lists.newArrayList(
                new ApplicationUser(
                        STUDENT.getGrantedAuthorities(),"abishek",
                        passwordEncoder.encode("abishek"),
                        true,
                        true,
                        true,
                        true
                ...
                new ApplicationUser(
                        ADMIN.getGrantedAuthorities(),"linda",
                ...
                new ApplicationUser(
                        ADMINTRAINEE.getGrantedAuthorities(),"spring",
                        passwordEncoder.encode("spring"),
                        true,
                        true,
                        true,
                        true
